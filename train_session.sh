...
python train.py --experiment=f2b --dataset=front2bev-aug --map_config=aug --model=pon --optimizer=adam --weight_mode=sqrt_inverse --pc=aircv 
...
python train.py --experiment=f2b --dataset=front2bev-aug --map_config=aug --model=ved --optimizer=adam --weight_mode=sqrt_inverse --pc=aircv 
